"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[358],{5002:function(e,t,n){n.d(t,{ET:function(){return sI},IO:function(){return ss},JU:function(){return iV},PL:function(){return s_},QT:function(){return sv},ad:function(){return iF},ar:function(){return so},hJ:function(){return iL},nP:function(){return sS},pl:function(){return sE},r7:function(){return sT}});var r,i,s,a,o=n(7818),l=n(2680),u=n(9053),h=n(3943),c=n(6552),d=n(4575);n(357);var f=n(9109).lW;let m="@firebase/firestore";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function tv(e,t){if(e.useProto3Json){if(isNaN(t))return{doubleValue:"NaN"};if(t===1/0)return{doubleValue:"Infinity"};if(t===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:J(t)?"-0":t}}function tw(e){return{integerValue:""+e}}function t_(e,t){return"number"==typeof t&&Number.isInteger(t)&&!J(t)&&t<=Number.MAX_SAFE_INTEGER&&t>=Number.MIN_SAFE_INTEGER?tw(t):tv(e,t)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class nV{constructor(){this.Tr=new es(nM.Er),this.dr=new es(nM.Ar)}isEmpty(){return this.Tr.isEmpty()}addReference(e,t){let n=new nM(e,t);this.Tr=this.Tr.add(n),this.dr=this.dr.add(n)}Rr(e,t){e.forEach(e=>this.addReference(e,t))}removeReference(e,t){this.Vr(new nM(e,t))}mr(e,t){e.forEach(e=>this.removeReference(e,t))}gr(e){let t=new K(new B([])),n=new nM(t,e),r=new nM(t,e+1),i=[];return this.dr.forEachInRange([n,r],e=>{this.Vr(e),i.push(e.key)}),i}pr(){this.Tr.forEach(e=>this.Vr(e))}Vr(e){this.Tr=this.Tr.delete(e),this.dr=this.dr.delete(e)}yr(e){let t=new K(new B([])),n=new nM(t,e),r=new nM(t,e+1),i=tp();return this.dr.forEachInRange([n,r],e=>{i=i.add(e.key)}),i}containsKey(e){let t=new nM(e,0),n=this.Tr.firstAfterOrEqual(t);return null!==n&&e.isEqual(n.key)}}class nM{constructor(e,t){this.key=e,this.wr=t}static Er(e,t){return K.comparator(e.key,t.key)||O(e.wr,t.wr)}static Ar(e,t){return O(e.wr,t.wr)||K.comparator(e.key,t.key)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class nz{constructor(e,t,n,r){this.targetId=e,this.fromCache=t,this.$i=n,this.Ui=r}static Wi(e,t){let n=tp(),r=tp();for(let e of t.docChanges)switch(e.type){case 0:n=n.add(e.doc.key);break;case 1:r=r.add(e.doc.key)}return new nz(e,t.fromCache,n,r)}}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function sv(e){e=iN(e,iR);let t=iN(e.firestore,iO);return(function(e,t,n={}){let r=new A;return e.asyncQueue.enqueueAndForget(async()=>(function(e,t,n,r,i){let s=new im({next:s=>{t.enqueueAndForget(()=>rB(e,a));let o=s.docs.has(n);!o&&s.fromCache?i.reject(new S(C.UNAVAILABLE,"Failed to get document because the client is offline.")):o&&s.fromCache&&r&&"server"===r.source?i.reject(new S(C.UNAVAILABLE,'Failed to get document from server. (However, this document does exist in the local cache. Run again without setting source to "server" to retrieve the cached document.)')):i.resolve(s)},error:e=>i.reject(e)}),a=new rG(new e8(n.path),s,{includeMetadataChanges:!0,_a:!0});return rq(e,a)})(await i_(e),e.asyncQueue,t,n,r)),r.promise})(iP(t),e._key).then(n=>(function(e,t,n){let r=n.docs.get(t._key),i=new sw(e);return new sg(e,i,t._key,r,new sm(n.hasPendingWrites,n.fromCache),t.converter)})(t,e,n))}class sw extends sd{constructor(e){super(),this.firestore=e}convertBytes(e){return new iq(e)}convertReference(e){let t=this.convertDocumentKey(e,this.firestore._databaseId);return new iR(this.firestore,null,t)}}function s_(e){e=iN(e,iD);let t=iN(e.firestore,iO),n=iP(t),r=new sw(t);return(/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function(e){if("L"===e.limitType&&0===e.explicitOrderBy.length)throw new S(C.UNIMPLEMENTED,"limitToLast() queries require specifying at least one orderBy() clause")}(e._query),(function(e,t,n={}){let r=new A;return e.asyncQueue.enqueueAndForget(async()=>(function(e,t,n,r,i){let s=new rG(n,new im({next:n=>{t.enqueueAndForget(()=>rB(e,s)),n.fromCache&&"server"===r.source?i.reject(new S(C.UNAVAILABLE,'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')):i.resolve(n)},error:e=>i.reject(e)}),{includeMetadataChanges:!0,_a:!0});return rq(e,s)})(await i_(e),e.asyncQueue,t,n,r)),r.promise})(n,e._query).then(n=>new sy(t,r,e,n)))}function sE(e,t,n){e=iN(e,iR);let r=iN(e.firestore,iO),i=sf(e.converter,t,n);return sC(r,[iJ(iX(r),"setDoc",e._key,i,null!==e.converter,n).toMutation(e._key,tL.none())])}function sT(e,t,n,...r){e=iN(e,iR);let i=iN(e.firestore,iO),s=iX(i);return sC(i,[("string"==typeof(t=(0,h.m9)(t))||t instanceof iB?function(e,t,n,r,i,s){let a=e.Nu(1,t,n),o=[i9(t,r,n)],l=[i];if(s.length%2!=0)throw new S(C.INVALID_ARGUMENT,`Function ${t}() needs to be called with an even number of arguments that alternate between field names and values.`);for(let e=0;e<s.length;e+=2)o.push(i9(t,s[e])),l.push(s[e+1]);let u=[],c=eO.empty();for(let e=o.length-1;e>=0;--e)if(!i7(u,o[e])){let t=o[e],n=l[e];n=(0,h.m9)(n);let r=a.Cu(t);if(n instanceof iZ)u.push(t);else{let e=i1(n,r);null!=e&&(u.push(t),c.set(t,e))}}return new ij(c,new eo(u),a.fieldTransforms)}(s,"updateDoc",e._key,t,n,r):function(e,t,n,r){let i=e.Nu(1,t,n);i4("Data must be an object, but it was:",i,r);let s=[],a=eO.empty();return ee(r,(e,r)=>{let o=i5(t,e,n);r=(0,h.m9)(r);let l=i.Cu(o);if(r instanceof iZ)s.push(o);else{let e=i1(r,l);null!=e&&(s.push(o),a.set(o,e))}}),new ij(a,new eo(s),i.fieldTransforms)}(s,"updateDoc",e._key,t)).toMutation(e._key,tL.exists(!0))])}function sI(e,t){let n=iN(e.firestore,iO),r=iV(e),i=sf(e.converter,t);return sC(n,[iJ(iX(e.firestore),"addDoc",r._key,i,null!==e.converter,{}).toMutation(r._key,tL.exists(!1))]).then(()=>r)}function sC(e,t){return function(e,t){let n=new A;return e.asyncQueue.enqueueAndForget(async()=>r4(await iw(e).then(e=>e.syncEngine),t,n)),n.promise}(iP(e),t)}function sS(e){return new i0("increment",e)}new WeakMap,function(e=!0){p=o.Jn,(0,o.Xd)(new l.wA("firestore",(t,{instanceIdentifier:n,options:r})=>{let i=t.getProvider("app").getImmediate(),s=new iO(new D(t.getProvider("auth-internal")),new V(t.getProvider("app-check-internal")),function(e,t){if(!Object.prototype.hasOwnProperty.apply(e.options,["projectId"]))throw new S(C.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new ev(e.options.projectId,t)}(i,n),i);return r=Object.assign({useFetchStreams:e},r),s._setSettings(r),s},"PUBLIC").setMultipleInstances(!0)),(0,o.KN)(m,"4.7.0",void 0),(0,o.KN)(m,"4.7.0","esm2017")}()}}]);